...
<a href="sample.php" class="btn btn-primary">ย้อนไปเพิ่มข้อมูลอีกครั้ง</a>
</div>
...
<td>
<a href="adjust.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm">แก้ไข/ปรับปรุงข้อมูล</a>
</td>
